          ...
          {request && request.status !== "credited" && (
            <div className={`${DASH_CARD} p-6 text-center`}>
              ...
              <p className="mt-4 text-lg font-semibold text-[#111827]">
                {request.bankName} — {formatCurrency(request.amount, request.currency)}
              </p>
              <span
              ...
              <p className="mt-4 text-sm leading-relaxed text-[#6B7280]">
                ...
                {request.status === "crediting" &&
                  "Your deposit was approved and is being added to your balance."}
