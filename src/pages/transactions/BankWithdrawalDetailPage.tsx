...
function statusBannerClass(status: BankWithdrawalSummary["status"]) {
  if (status === "completed") return "bg-[#F0FDF4] text-[#16A34A]";
  if (status === "declined") return "bg-[#FEF2F2] text-[#DC2626]";
  return "bg-[#FFFBEB] text-[#B45309]";
}

function statusMessage(request: BankWithdrawalSummary) {
...
export function BankWithdrawalDetailPage() {
